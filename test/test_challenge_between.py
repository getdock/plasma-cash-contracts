...
def test_failing_challenge_1(setup_participate):
    ...
    # bob to charlie tx.
    bob_charlie = generate.generate_tx(
        coins[0],
    ...
    # plasma block is generated and submited to mainnet
    bob_charlie["proof"], bob_charlie["block_number"] = generate.generate_block(
...
def test_double_spend(setup_participate):
    ...
    bob_dylan = generate.generate_tx(
        coins[8],
        alice_bob["block_number"],
        COIN_DENOMINATION,
        dylan_addr,
    ...
    # plasma block is generated and submited to mainnet
    bob_dylan["proof"], bob_dylan["block_number"] = generate.generate_block(
